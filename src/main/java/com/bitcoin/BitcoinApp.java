...
import com.bitcoin.config.ApplicationProperties;
import com.bitcoin.config.DefaultProfileUtil;
...
public class BitcoinApp {
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(BitcoinApp.class);
